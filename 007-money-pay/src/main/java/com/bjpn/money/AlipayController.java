...
import com.bjpn.money.Aliconfig.AlipayConfig;
...
public class AlipayController {
    ...
    @PostMapping("/loan/pay/alipay")
    public void alipay(@RequestParam(name = "out_trade_no",required = true)String out_trade_no,
